...
var FeatureData = struct {
	ControlPlane  feature.DataDefinition[dsciv2.DSCInitializationSpec, infrav1.ControlPlaneSpec]
	Authorization AuthorizationData
}{
	ControlPlane: feature.DataDefinition[dsciv2.DSCInitializationSpec, infrav1.ControlPlaneSpec]{
		Define: func(source *dsciv2.DSCInitializationSpec) feature.DataEntry[infrav1.ControlPlaneSpec] {
	...
	Authorization: AuthorizationData{
		...
		All: func(source *dsciv2.DSCInitializationSpec) []feature.Action {
...
type AuthorizationData struct {
	Spec                  feature.DataDefinition[dsciv2.DSCInitializationSpec, infrav1.AuthSpec]
	Namespace             feature.DataDefinition[dsciv2.DSCInitializationSpec, string]
	Provider              feature.DataDefinition[dsciv2.DSCInitializationSpec, string]
	ExtensionProviderName feature.DataDefinition[dsciv2.DSCInitializationSpec, string]
	All                   func(source *dsciv2.DSCInitializationSpec) []feature.Action
}

var authSpec = feature.DataDefinition[dsciv2.DSCInitializationSpec, infrav1.AuthSpec]{
	Define: func(source *dsciv2.DSCInitializationSpec) feature.DataEntry[infrav1.AuthSpec] {
...
var authNs = feature.DataDefinition[dsciv2.DSCInitializationSpec, string]{
	Define: func(source *dsciv2.DSCInitializationSpec) feature.DataEntry[string] {
...
var authProvider = feature.DataDefinition[dsciv2.DSCInitializationSpec, string]{
	Define: func(source *dsciv2.DSCInitializationSpec) feature.DataEntry[string] {
		return feature.DataEntry[string]{
...
var authExtensionName = feature.DataDefinition[dsciv2.DSCInitializationSpec, string]{
	Define: func(source *dsciv2.DSCInitializationSpec) feature.DataEntry[string] {
		return feature.DataEntry[string]{
