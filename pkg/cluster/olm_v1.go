...
// isOLMv1Unavailable reports whether an API error means OLMv1 resources cannot be queried.
func isOLMv1Unavailable(err error) bool {
	return meta.IsNoMatchError(err) || k8serr.IsNotFound(err) || k8serr.IsForbidden(err)
}
