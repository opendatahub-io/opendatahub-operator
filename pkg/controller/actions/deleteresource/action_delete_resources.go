...
import (
	...
	fwdr "github.com/opendatahub-io/odh-platform-utilities/framework/controller/actions/deleteresource"
...
func NewAction(opts ...ActionOpts) actions.Fn {
	defaults := make([]ActionOpts, 0, 1+len(opts))
	defaults = append(defaults, fwdr.WithNamespaceFn(func(ctx context.Context, rr *types.ReconciliationRequest) (string, error) {
