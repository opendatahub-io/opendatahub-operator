		...
		t.Run(tt.name, func(t *testing.T) {
			...
			rr := types.ReconciliationRequest{
				...
				Release: fwapi.Release{
					...
					Version: version.OperatorVersion{Version: tt.version},
				},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			rr := types.ReconciliationRequest{
				...
				Release: fwapi.Release{
					Name:    cluster.OpenDataHub,
					Version: version.OperatorVersion{Version: semver.Version{Major: 0, Minor: 0, Patch: 1}},
				},
				Generated: true,
				Controller: mocks.NewMockController(func(m *mocks.MockController) {
					m.On("GetClient").Return(sharedEnvTest.Client())
...
func TestGcActionCluster(t *testing.T) {
	...
	rr := types.ReconciliationRequest{
		...
		Release: fwapi.Release{
			Name:    cluster.OpenDataHub,
			Version: version.OperatorVersion{Version: semver.Version{Major: 0, Minor: 2, Patch: 0}},
		},
		Generated: true,
		Controller: mocks.NewMockController(func(m *mocks.MockController) {
			m.On("GetClient").Return(sharedEnvTest.Client())
...
func TestGcActionWithPartOfLabel(t *testing.T) {
	...
	rr := types.ReconciliationRequest{
		...
		Release: fwapi.Release{
			Name:    cluster.OpenDataHub,
			Version: version.OperatorVersion{Version: semver.Version{Major: 0, Minor: 1, Patch: 0}},
		},
		Generated: true,
		Controller: mocks.NewMockController(func(m *mocks.MockController) {
