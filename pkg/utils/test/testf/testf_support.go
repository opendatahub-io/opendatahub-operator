...
// If the object has no status field, the status update is silently skipped.
// This two-step process is needed because the Kubernetes API does not allow setting status on create.
