...
func (v *Validator) warnDeprecatedModelsAsService(ctx context.Context, _ client.Reader, req *admission.Request) admission.Response {
	...
	resp.Warnings = dscwebhook.ModelsAsServiceDeprecationWarnings(dcsV1.Spec.Components.Kserve.ModelsAsService.ManagementState) //nolint:staticcheck // deprecation warning
	return resp
}
