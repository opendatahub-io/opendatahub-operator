...
func TestDataScienceClusterV1_Integration(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			test: func(g Gomega, ctx context.Context, k8sClient client.Client, ns string) {
				dsc := envtestutil.NewDSCV1("dsc-one", ns)
		...
		},
		{
			...
			setup: func(ns string) []client.Object {
				return []client.Object{
					envtestutil.NewDSCV1("existing", ns),
				}
			},
			test: func(g Gomega, ctx context.Context, k8sClient client.Client, ns string) {
				dsc := envtestutil.NewDSCV1("dsc-two", ns)
		...
		},
		{
			...
			setup: func(ns string) []client.Object {
				return []client.Object{
					envtestutil.NewDSCV1("dsc-delete", ns),
				}
			},
			test: func(g Gomega, ctx context.Context, k8sClient client.Client, ns string) {
		...
		},
		{
			...
			test: func(g Gomega, ctx context.Context, k8sClient client.Client, ns string) {
				dsc := envtestutil.NewDSCV1("dsc-defaulting", ns, WithModelRegistryDefaulting())
