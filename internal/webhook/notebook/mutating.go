...
//+kubebuilder:webhook:path=/platform-connection-notebook,mutating=true,failurePolicy=fail,groups=kubeflow.org,resources=notebooks,verbs=create;update,versions=v1;v2,name=connection-notebook.opendatahub.io,sideEffects=None,admissionReviewVersions=v1
//nolint:lll
