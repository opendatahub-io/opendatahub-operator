...
// workloadConfig defines the configuration paths for different workload types.
...
// getWorkloadConfig returns the configuration paths for a given workload kind.
// This function provides the mapping between workload types and their specific
// JSON paths for containers, nodeSelector, and tolerations.
//
// The configuration enables the webhook to handle different workload types that
// have varying spec structures while using the same application logic.
//
// Parameters:
