...
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=metrics-reader;servicemesh-operator3-clusterrole;servicemeshoperator3-metrics-reader
