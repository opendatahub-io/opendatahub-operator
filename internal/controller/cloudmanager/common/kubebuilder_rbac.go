...
// Upgrade path: cert-manager was previously installed via Helm chart. These RBAC
// entries allow GC to clean up the old cert-manager-operator Role/ClusterRole
// resources during upgrade from versions that managed cert-manager installation.
