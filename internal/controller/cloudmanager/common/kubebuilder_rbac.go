...
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=roles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=kagenti-leader-election-role
...
//
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=kagenti-manager-role;kagenti-metrics-auth-role;kagenti-metrics-reader;kagenti-operator-httproute-agents-operator
...
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=odh-observability-manager
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=metrics-reader;servicemesh-operator3-clusterrole
