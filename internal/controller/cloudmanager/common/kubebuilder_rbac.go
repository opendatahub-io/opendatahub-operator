...
// Events
// +kubebuilder:rbac:groups="events.k8s.io",resources=events,verbs=create;list;watch;patch;get
...
// +auto:rbac:begin -- DO NOT EDIT BELOW. Generated by hack/update-cloudmanager-rbac.sh
...
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=roles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=authorino-operator-role;dns-operator-controller-manager-role;kuadrant-operator-controller-manager-role;kuadrant-operator-controller-manager-role-1;limitador-operator-controller-manager-role
...
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=authorino-authconfig-editor-role;authorino-authconfig-viewer-role;authorino-manager-k8s-auth-role;authorino-manager-role;authorino-operator-clusterrole;dns-operator-controller-manager-clusterrole;dns-operator-metrics-reader;dns-operator-remote-cluster-role;kuadrant-operator-controller-manager-clusterrole;kuadrant-operator-controller-manager-clusterrole-1;limitador-operator-controller-manager-clusterrole;limitador-operator-metrics-reader
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=servicemesh-operator3-clusterrole;servicemeshoperator3-metrics-reader
// +auto:rbac:end -- DO NOT EDIT ABOVE. Generated by hack/update-cloudmanager-rbac.sh

// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=metrics-reader
