...
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=roles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=opendatahub-ai-gateway-leader-election-role
...
//
// +kubebuilder:rbac:groups="rbac.authorization.k8s.io",resources=clusterroles,verbs=get;list;watch;patch;update;delete;bind;escalate,resourceNames=opendatahub-ai-gateway-components-aigateway-admin-role;opendatahub-ai-gateway-components-aigateway-editor-role;opendatahub-ai-gateway-components-aigateway-viewer-role;opendatahub-ai-gateway-manager-role;opendatahub-ai-gateway-metrics-auth-role;opendatahub-ai-gateway-metrics-reader
