...
func updateInferenceCM(inferenceServiceConfigMap *corev1.ConfigMap, isHeadless bool, modelCacheEnabled bool, oauthProxy *componentApi.OAuthProxyConfig) error {
	// ingress
