...
|--------|---------|-----------------|----------|
| [AI Gateway](./aigateway/) | `aigateway.NewHandler()` | Kustomize (`SourcePathByPlatform`) | `dag.RL(32)` |
| [Spark Operator](./sparkoperator/) | `sparkoperator.NewHandler()` | Kustomize (`SourcePath: default`) | `dag.RL(32)` |
