...
// Tenant (DSC materialization; platform reconcile in maas-controller)
...
// +kubebuilder:rbac:groups=maas.opendatahub.io,resources=tenants/finalizers,verbs=update;patch
