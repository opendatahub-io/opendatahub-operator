...
import (
	...
	batchgatewaymodule "github.com/opendatahub-io/opendatahub-operator/v2/internal/controller/modules/batchgateway"
...
var (
	...
	existingModules = map[string]mr.ModuleHandler{
		...
		componentApi.BatchGatewayComponentName: batchgatewaymodule.NewHandler(),
	}
)
