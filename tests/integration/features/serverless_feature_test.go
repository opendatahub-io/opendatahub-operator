...
var _ = Describe("Serverless feature", func() {
	...
	var (
		...
		kserveComponent *componentsv1alpha1.Kserve
	)
	...
	Context("verifying preconditions", func() {
		...
		When("operator is not installed", func() {
			...
			It("should fail on precondition check", func(ctx context.Context) {
				...
				featuresHandler := feature.ComponentFeaturesHandler(dsci, componentsv1alpha1.KserveComponentName, dsci.Spec.ApplicationsNamespace, featuresProvider)
