...
// setupNamespace creates a test namespace with the base "test-type: kqueue" label and optional additional labels.
// This function automatically adds the standard Kqueue test label and merges any additional labels provided.
// All namespaces created with this function can be cleaned up in bulk using the "test-type: kqueue" label selector.
//
// Parameters:
