...
func v2Tov3UpgradeTestSuite(t *testing.T) {
	...
	// cleanup service mesh CRD
	tc.DeleteResource(
		WithMinimalObject(gvk.CustomResourceDefinition, types.NamespacedName{Name: strings.ToLower(gvk.ServiceMesh.Kind) + "s." + gvk.ServiceMesh.Group}),
	)
}
