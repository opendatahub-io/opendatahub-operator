...
|----------|---------|---------|
| 20 | Dashboard, DataSciencePipelines, ModelRegistry, Ray, Trainer, TrainingOperator, Workbenches, MCPLifecycleOperator (module) | Core AI/ML and independent modules — no inter-entry dependencies |
...
DAG blast radius: a Spark failure blocks only RL(33) entries, not KServe or other extensions.
