...
| `metricsAllowedGroups` _string array_ | MetricsAllowedGroups defines groups with read access to metrics resources. Cannot contain 'system:authenticated' or empty strings |  |  |
