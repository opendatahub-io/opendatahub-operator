...
| `batchgateway` _[DSCBatchGateway](#dscbatchgateway)_ | BatchGateway component configuration. |  |  |
...
| `batchgateway` _[DSCBatchGatewayStatus](#dscbatchgatewaystatus)_ | BatchGateway component status. |  |  |
