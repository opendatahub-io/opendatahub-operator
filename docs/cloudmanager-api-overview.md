...
| `kind` _string_ | `AWSKubernetesEngine` | | |
...
| `spec` _[AWSKubernetesEngineSpec](#awskubernetesenginespec)_ |  |  |  |
| `status` _[AWSKubernetesEngineStatus](#awskubernetesenginestatus)_ |  |  |  |


#### AWSKubernetesEngineSpec
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `dependencies` _[Dependencies](#dependencies)_ | Dependencies defines the dependency configurations for the AWS Kubernetes Engine. |  |  |


#### AWSKubernetesEngineStatus
