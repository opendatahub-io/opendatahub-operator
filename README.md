...
| E2E_TEST_COMPONENTS                      | *(Deprecated)* Enable per-component tests (superseded by platform orchestration tests, remove once modularisation is complete)                                                                                             | `false`                       |
...
| --test-components                     | *(Deprecated)* Enable per-component tests (superseded by platform orchestration tests, remove once modularisation is complete)                                                                                             | `false`                       |
