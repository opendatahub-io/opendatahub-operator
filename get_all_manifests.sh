...
declare -A RHOAI_COMPONENT_MANIFESTS=(
    ["dashboard"]="red-hat-data-services:odh-dashboard:${RHOAI_BRANCH}:manifests"
    ["workbenches/kf-notebook-controller"]="red-hat-data-services:kubeflow:${RHOAI_BRANCH}:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="red-hat-data-services:kubeflow:${RHOAI_BRANCH}:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="red-hat-data-services:notebooks:${RHOAI_BRANCH}:manifests"
    ["kserve"]="red-hat-data-services:kserve:${RHOAI_BRANCH}:config"
    ["ray"]="red-hat-data-services:kuberay:${RHOAI_BRANCH}:ray-operator/config"
    ["trustyai"]="red-hat-data-services:trustyai-service-operator:${RHOAI_BRANCH}:config"
    ["modelregistry"]="red-hat-data-services:model-registry-operator:${RHOAI_BRANCH}:config"
    ["trainingoperator"]="red-hat-data-services:training-operator:${RHOAI_BRANCH}:manifests"
    ["datasciencepipelines"]="red-hat-data-services:data-science-pipelines-operator:${RHOAI_BRANCH}:config"
    ["modelcontroller"]="red-hat-data-services:odh-model-controller:${RHOAI_BRANCH}:config"
    ["feastoperator"]="red-hat-data-services:feast:${RHOAI_BRANCH}:infra/feast-operator/config"
    ["llamastackoperator"]="red-hat-data-services:llama-stack-k8s-operator:${RHOAI_BRANCH}:config"
    ["trainer"]="red-hat-data-services:trainer:${RHOAI_BRANCH}:manifests"
    ["maas"]="red-hat-data-services:maas-billing:${RHOAI_BRANCH}:deployment"
    ["mlflowoperator"]="red-hat-data-services:mlflow-operator:${RHOAI_BRANCH}:config"
    ["sparkoperator"]="red-hat-data-services:spark-operator:${RHOAI_BRANCH}:config"
