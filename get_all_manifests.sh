...
declare -A COMPONENT_MANIFESTS=(
    ["codeflare"]="opendatahub-io:codeflare-operator:v1.4.4-odh:config:codeflare"
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.24.1-odh-release:manifests:dashboard"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:v1.22.0:config:trustyai-service-operator"
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v0.12.0.1-rc0:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v0.12.0.2:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v0.12.1.2:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v0.2.2:config:model-registry-operator"
