...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.26.2-odh-release:manifests:dashboard"
    ...
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.7:config:model-registry-operator"
