...
declare -A COMPONENT_MANIFESTS=(
    ["codeflare"]="opendatahub-io:codeflare-operator:v1.8.0-odh:config:codeflare"
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.26.1-odh-release:manifests:dashboard"
    ...
    ["notebooks"]="opendatahub-io:notebooks:v1.22.0:manifests:notebooks"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.26.0:config:trustyai-service-operator"
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v0.12.0.5-rc0:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v0.12.0.6:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v0.12.1.6:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.6:config:model-registry-operator"
