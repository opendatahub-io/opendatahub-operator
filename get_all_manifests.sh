...
declare -A ODH_COMPONENT_MANIFESTS=(
    ...
    ["trainer"]="opendatahub-io:trainer-operator:main@60e5ac8e985561cb3177aed6357063781389183b:config"
...
declare -A RHOAI_COMPONENT_MANIFESTS=(
    ...
    ["trainer"]="red-hat-data-services:trainer-operator:rhoai-3.5@1cc590b4685463a4e5b699e8ca06ed5750a6aabd:config"
