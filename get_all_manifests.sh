...
declare -A ODH_COMPONENT_MANIFESTS=(
    ...
    ["kserve"]="opendatahub-io:kserve:release-v0.17@ce3713d2d96ed3f09b07e0d0a5bb50d03d286033:config"
    ...
    ["modelcontroller"]="opendatahub-io:odh-model-controller:incubating@75a5d2bda6be69ae5d3dd4f82e995519a034a6d4:config"
