...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="red-hat-data-services:odh-dashboard:rhoai-2.23:manifests"
    ["workbenches/kf-notebook-controller"]="red-hat-data-services:kubeflow:rhoai-2.23:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="red-hat-data-services:kubeflow:rhoai-2.23:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="red-hat-data-services:notebooks:rhoai-2.23:manifests"
    ["modelmeshserving"]="red-hat-data-services:modelmesh-serving:rhoai-2.23:config"
    ["kserve"]="red-hat-data-services:kserve:rhoai-2.23:config"
    ["kueue"]="red-hat-data-services:kueue:rhoai-2.23:config"
    ["codeflare"]="red-hat-data-services:codeflare-operator:rhoai-2.23:config"
    ["ray"]="red-hat-data-services:kuberay:rhoai-2.23:ray-operator/config"
    ["trustyai"]="red-hat-data-services:trustyai-service-operator:rhoai-2.23:config"
    ["modelregistry"]="red-hat-data-services:model-registry-operator:rhoai-2.23:config"
    ["trainingoperator"]="red-hat-data-services:training-operator:rhoai-2.23:manifests"
    ["datasciencepipelines"]="red-hat-data-services:data-science-pipelines-operator:rhoai-2.23:config"
    ["modelcontroller"]="red-hat-data-services:odh-model-controller:rhoai-2.23:config"
    ["feastoperator"]="red-hat-data-services:feast:rhoai-2.23:infra/feast-operator/config"
    ["llamastackoperator"]="red-hat-data-services:llama-stack-k8s-operator:rhoai-2.23:config"
)
