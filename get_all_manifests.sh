...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v0.12.0.3-rc0:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v0.12.0.4:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v0.12.1.4:config:kserve"
