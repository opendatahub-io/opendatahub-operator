...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.29.3-odh:manifests"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:v1.31.1:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v0.2.12:config"
