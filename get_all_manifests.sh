...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="red-hat-data-services:odh-dashboard:v2.38.1-odh:manifests"
    ["workbenches/kf-notebook-controller"]="red-hat-data-services:kubeflow:v1.10.0-6:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="red-hat-data-services:kubeflow:v1.10.0-6:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="red-hat-data-services:notebooks:v1.36.0:manifests"
    ["modelmeshserving"]="red-hat-data-services:modelmesh-serving:odh-v2.35:config"
    ["kserve"]="red-hat-data-services:kserve:odh-v2.35:config"
    ["kueue"]="red-hat-data-services:kueue:stable-2.x:config"
    ["codeflare"]="red-hat-data-services:codeflare-operator:v1.16.0:config"
    ["ray"]="red-hat-data-services:kuberay:v1.4.0:ray-operator/config"
    ["trustyai"]="red-hat-data-services:trustyai-service-operator:odh-2.35:config"
    ["modelregistry"]="red-hat-data-services:model-registry-operator:v0.3.1:config"
    ["trainingoperator"]="red-hat-data-services:training-operator:v1.9.0-odh-3:manifests"
    ["datasciencepipelines"]="red-hat-data-services:data-science-pipelines-operator:v2.15.1:config"
    ["modelcontroller"]="red-hat-data-services:odh-model-controller:odh-v2.35:config"
    ["feastoperator"]="red-hat-data-services:feast:v0.54.0:infra/feast-operator/config"
    ["llamastackoperator"]="red-hat-data-services:llama-stack-k8s-operator:v0.3.0:config"
)
