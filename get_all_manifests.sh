...
declare -A COMPONENT_MANIFESTS=(
    ["codeflare"]="opendatahub-io:codeflare-operator:v1.10.0:config:codeflare"
    ["ray"]="opendatahub-io:kuberay:v1.1.0-odh-1:ray-operator/config:ray"
    ["kueue"]="opendatahub-io:kueue:v0.8.1-2:config:kueue"
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.28.1-odh-release:manifests:dashboard"
    ["kf-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-2:components/notebook-controller/config:odh-notebook-controller/kf-notebook-controller"
    ["odh-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-2:components/odh-notebook-controller/config:odh-notebook-controller/odh-notebook-controller"
    ["notebooks"]="opendatahub-io:notebooks:v1.24.0:manifests:notebooks"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.28.0:config:trustyai-service-operator"
    ...
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.9:config:model-registry-operator"
