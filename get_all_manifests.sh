...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.19.1-incubation-release:manifests:dashboard"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.16.0:config:trustyai-service-operator"
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v0.11.1.2:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v0.11.1.2:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v0.11.1.2:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v0.1.1:config:model-registry-operator"
)
