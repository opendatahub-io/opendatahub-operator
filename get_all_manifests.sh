...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.33.1-odh-release:manifests"
    ...
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.28:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.28:config"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.36.0:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.17:config"
    ...
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v2.28:config"
