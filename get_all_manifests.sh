...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-5:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-5:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.35.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.34:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.34:config"
    ["kueue"]="opendatahub-io:kueue:stable-2.x:config"
    ["codeflare"]="opendatahub-io:codeflare-operator:v1.16.0:config"
    ["ray"]="opendatahub-io:kuberay:v1.4.0:ray-operator/config"
    ["trustyai"]="opendatahub-io:trustyai-service-operator:release/odh-2.34:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.3.0:config"
    ...
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v2.34:config"
    ["feastoperator"]="opendatahub-io:feast:v0.53.0:infra/feast-operator/config"
