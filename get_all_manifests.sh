...
declare -A ODH_COMPONENT_MANIFESTS=(
    ...
    ["mcplifecycleoperator"]="opendatahub-io:mcp-lifecycle-module-operator:main@3f19a5a16a3caa8e2b02a0ba71ee8f35c99f574d:config"
)
...
declare -A RHOAI_COMPONENT_MANIFESTS=(
    ...
    ["mcplifecycleoperator"]="red-hat-data-services:mcp-lifecycle-module-operator:rhoai-3.5:config"
)
