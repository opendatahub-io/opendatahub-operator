...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["ray"]="opendatahub-io:kuberay:v1.1.1-odh:ray-operator/config:ray"
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.23.0-odh-release:manifests:dashboard"
    ["kf-notebook-controller"]="opendatahub-io:kubeflow:v1.7.0-11:components/notebook-controller/config:odh-notebook-controller/kf-notebook-controller"
    ["odh-notebook-controller"]="opendatahub-io:kubeflow:v1.7.0-11:components/odh-notebook-controller/config:odh-notebook-controller/odh-notebook-controller"
    ["notebooks"]="opendatahub-io:notebooks:v1.19.0:manifests:notebooks"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.21.0:config:trustyai-service-operator"
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v0.12.0.1-rc0:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v0.12.0.1:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v0.12.1.1:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v0.2.1:config:model-registry-operator"
