...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.22.2-odh-release:manifests:dashboard"
    ...
    ["notebooks"]="opendatahub-io:notebooks:v1.18.0:manifests:notebooks"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.20.0:config:trustyai-service-operator"
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v0.12.0.0-rc0:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v0.12.0.0:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v0.12.1.0:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v0.2.0:config:model-registry-operator"
