...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.31.2-odh-release:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-9:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-9:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.28.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.26:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.26:config"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.34.0:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.15:config"
    ...
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v2.26:config"
