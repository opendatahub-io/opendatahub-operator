...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.38.1-odh:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-6:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-6:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.36.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.35:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.35:config"
    ...
    ["trustyai"]="opendatahub-io:trustyai-service-operator:odh-2.35:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v0.3.1:config"
