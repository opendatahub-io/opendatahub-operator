...
declare -A COMPONENT_MANIFESTS=(
    ["codeflare"]="opendatahub-io:codeflare-operator:v1.11.0:config:codeflare"
    ...
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.29.1-odh-release:manifests:dashboard"
    ["kf-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-4:components/notebook-controller/config:odh-notebook-controller/kf-notebook-controller"
    ["odh-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-4:components/odh-notebook-controller/config:odh-notebook-controller/odh-notebook-controller"
    ["notebooks"]="opendatahub-io:notebooks:v1.26.0:manifests:notebooks"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.29.0:config:trustyai-service-operator"
    ["model-mesh"]="opendatahub-io:modelmesh-serving:odh-v2.21:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:odh-v2.21:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:odh-v2.21:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.10:config:model-registry-operator"
