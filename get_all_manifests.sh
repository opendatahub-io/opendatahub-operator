...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.32.1-odh-release:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-10:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.9.0-10:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.29.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.27:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.27:config"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.35.0:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.16:config"
    ["trainingoperator"]="opendatahub-io:training-operator:v1.9.0-odh-2:manifests"
    ["datasciencepipelines"]="opendatahub-io:data-science-pipelines-operator:v2.11.0:config"
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v2.27:config"
    ["feastoperator"]="opendatahub-io:feast:v0.48-branch:infra/feast-operator/config"
)
