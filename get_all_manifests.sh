...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.32:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.32:config"
    ...
    ["trustyai"]="opendatahub-io:trustyai-service-operator:release/odh-2.32:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release-v0.2.21:config"
    ...
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v2.32:config"
