...
func devFlags(ctx context.Context, rr *odhtypes.ReconciliationRequest) error {
	trainingoperator, ok := rr.Instance.(*componentsv1alpha1.TrainingOperator)
	if !ok {
		return fmt.Errorf("resource instance %v is not a componentsv1alpha1.TrainingOperator)", rr.Instance)
	}
