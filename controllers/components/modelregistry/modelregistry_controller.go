...
func (s *componentHandler) NewComponentReconciler(ctx context.Context, mgr ctrl.Manager) error {
	_, err := reconciler.ReconcilerFor(mgr, &componentsv1alpha1.ModelRegistry{}).
		...
		Watches(
			...
			reconciler.WithEventHandler(handlers.ToNamed(componentsv1alpha1.ModelRegistryInstanceName)),
