...
var (
	imageParamMap = map[string]string{
		...
		"IMAGES_OAUTHPROXY":                "RELATED_IMAGE_ODH_ML_PIPELINES_OAUTHPROXY_IMAGE",
		"IMAGES_MARIADB":                   "RELATED_IMAGE_ODH_ML_PIPELINES_MARIADB_IMAGE",
		"IMAGES_MLMDENVOY":                 "RELATED_IMAGE_ODH_ML_PIPELINES_MLMDENVOY_IMAGE",
	}
