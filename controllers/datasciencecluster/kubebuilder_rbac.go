...
// +kubebuilder:rbac:groups="route.openshift.io",resources=routes,verbs=create;delete;list;update;watch;patch;get
...
// +kubebuilder:rbac:groups="core",resources=endpoints,verbs=watch;list;create;update;delete
