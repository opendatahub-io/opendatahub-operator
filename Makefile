...
CRD_REF_DOCS ?= go run github.com/elastic/crd-ref-docs
...
.PHONY: api-docs
api-docs: ## Creates API docs using https://github.com/elastic/crd-ref-docs, render managementstate with marker
