...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DashboardRedirectConfig) DeepCopyInto(out *DashboardRedirectConfig) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DashboardRedirectConfig.
func (in *DashboardRedirectConfig) DeepCopy() *DashboardRedirectConfig {
	if in == nil {
		return nil
	}
	out := new(DashboardRedirectConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GatewayConfigSpec) DeepCopyInto(out *GatewayConfigSpec) {
	*out = *in
	...
	if in.DashboardRedirect != nil {
		in, out := &in.DashboardRedirect, &out.DashboardRedirect
		*out = new(DashboardRedirectConfig)
		(*in).DeepCopyInto(*out)
	}
}
