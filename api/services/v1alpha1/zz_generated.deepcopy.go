...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TracesStorageSpec) DeepCopyInto(out *TracesStorageSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TracesStorageSpec.
func (in *TracesStorageSpec) DeepCopy() *TracesStorageSpec {
	if in == nil {
		return nil
	}
	out := new(TracesStorageSpec)
	in.DeepCopyInto(out)
	return out
}
