...
func (in *MetricsResources) DeepCopyInto(out *MetricsResources) {
	*out = *in
	out.MonitoringStackCPULimit = in.MonitoringStackCPULimit.DeepCopy()
	out.MonitoringStackCPURequest = in.MonitoringStackCPURequest.DeepCopy()
	out.MonitoringStackMemoryLimit = in.MonitoringStackMemoryLimit.DeepCopy()
	out.MonitoringStackMemoryRequest = in.MonitoringStackMemoryRequest.DeepCopy()
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SharedResources) DeepCopyInto(out *SharedResources) {
	*out = *in
	out.CollectorCPULimit = in.CollectorCPULimit.DeepCopy()
	out.CollectorCPURequest = in.CollectorCPURequest.DeepCopy()
	out.CollectorMemoryLimit = in.CollectorMemoryLimit.DeepCopy()
	out.CollectorMemoryRequest = in.CollectorMemoryRequest.DeepCopy()
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SharedResources.
func (in *SharedResources) DeepCopy() *SharedResources {
	if in == nil {
		return nil
	}
	out := new(SharedResources)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TempoResources) DeepCopyInto(out *TempoResources) {
	*out = *in
	out.TempoStackCPULimit = in.TempoStackCPULimit.DeepCopy()
	out.TempoStackCPURequest = in.TempoStackCPURequest.DeepCopy()
	out.TempoStackMemoryLimit = in.TempoStackMemoryLimit.DeepCopy()
	out.TempoStackMemoryRequest = in.TempoStackMemoryRequest.DeepCopy()
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TempoResources.
func (in *TempoResources) DeepCopy() *TempoResources {
	if in == nil {
		return nil
	}
	out := new(TempoResources)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Traces) DeepCopyInto(out *Traces) {
	*out = *in
	...
	if in.TempoResources != nil {
		in, out := &in.TempoResources, &out.TempoResources
		*out = new(TempoResources)
		(*in).DeepCopyInto(*out)
	}
}
