...
func (in *AuthSpec) DeepCopyInto(out *AuthSpec) {
	*out = *in
	...
	if in.MetricsAdminGroups != nil {
		in, out := &in.MetricsAdminGroups, &out.MetricsAdminGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.MetricsAllowedGroups != nil {
		in, out := &in.MetricsAllowedGroups, &out.MetricsAllowedGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
