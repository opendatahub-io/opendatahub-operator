...
type Components struct {
	...
	// AIHub component configuration.
	AIHub componentApi.DSCAIHub `json:"aiHub,omitempty"`

	// Data component configuration.
	Data componentApi.DSCData `json:"data,omitempty"`
...
type ComponentsStatus struct {
	...
	// AIHub component status.
	AIHub componentApi.DSCAIHubStatus `json:"aiHub,omitempty"`
