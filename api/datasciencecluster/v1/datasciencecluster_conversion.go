...
func (c *DataScienceCluster) ConvertTo(dstRaw conversion.Hub) error {
	...
	// Convert spec with field renaming: DataSciencePipelines -> AIPipelines
	dst.Spec.Components = dscv2.Components{
		...
		CodeFlare:          c.Spec.Components.CodeFlare,
	...
	dst.Status = dscv2.DataScienceClusterStatus{
		...
		Components: dscv2.ComponentsStatus{
			...
			CodeFlare:          c.Status.Components.CodeFlare,
...
func (c *DataScienceCluster) ConvertFrom(srcRaw conversion.Hub) error {
	...
	// Convert spec with field renaming: AIPipelines -> DataSciencePipelines
	c.Spec.Components = Components{
		...
		CodeFlare:            src.Spec.Components.CodeFlare,
	...
	c.Status = DataScienceClusterStatus{
		...
		Components: ComponentsStatus{
			...
			CodeFlare:            src.Status.Components.CodeFlare,
